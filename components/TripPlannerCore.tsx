...
const s=StyleSheet.create({
  safe:{flex:1,backgroundColor:'transparent'},content:{padding:SPACING.lg,paddingBottom:130,gap:16,maxWidth:1420,width:'100%',alignSelf:'center'},pressFill:{width:'100%',height:'100%',alignItems:'stretch',justifyContent:'center'},
  hero:{overflow:'hidden',borderRadius:28,backgroundColor:'rgba(69,229,241,.16)',borderWidth:1,borderColor:'rgba(255,255,255,.20)',padding:22,minHeight:132},heroContent:{flex:1,flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:18,flexWrap:'wrap'},heroOrb:{position:'absolute',borderRadius:999,backgroundColor:'rgba(130,244,251,.16)'},heroOrbA:{width:220,height:220,right:-60,top:-120},heroOrbB:{width:150,height:150,right:220,bottom:-105,backgroundColor:'rgba(244,214,155,.18)'},eyebrow:{alignSelf:'flex-start',flexDirection:'row',alignItems:'center',gap:6,backgroundColor:'rgba(3,50,72,.52)',paddingHorizontal:10,paddingVertical:6,borderRadius:999,borderWidth:1,borderColor:'rgba(255,255,255,.20)'},eyebrowText:{fontSize:9,fontWeight:'900',letterSpacing:1.1,color:COLORS.primaryDark},title:{fontSize:31,fontWeight:'900',color:COLORS.text,marginTop:7},sub:{color:COLORS.textMuted,marginTop:4,lineHeight:20,maxWidth:760},heroCreate:{minWidth:235,minHeight:66,borderRadius:20,backgroundColor:COLORS.dark,padding:10,paddingRight:16,...SHADOW},heroCreateOn:{backgroundColor:'rgba(6,59,87,.94)'},heroCreateIcon:{width:44,height:44,borderRadius:15,backgroundColor:COLORS.primary,alignItems:'center',justifyContent:'center',position:'absolute',left:10,top:11},heroCreateText:{marginLeft:56,color:'#fff',fontSize:13,fontWeight:'900'},heroCreateSub:{marginLeft:56,color:'rgba(255,255,255,.58)',fontSize:9,marginTop:3},
  overview:{flexDirection:'row',gap:10,flexWrap:'wrap'},stat:{minWidth:150,flex:1,backgroundColor:'rgba(3,50,72,.64)',borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:20,padding:14,...SHADOW},statIcon:{width:36,height:36,borderRadius:13,backgroundColor:'rgba(69,229,241,.14)',alignItems:'center',justifyContent:'center'},statN:{fontSize:22,fontWeight:'900',color:COLORS.text,marginTop:8},statLabel:{fontSize:10,color:COLORS.textMuted,marginTop:2,fontWeight:'700'},
  createBanner:{minHeight:78,backgroundColor:'rgba(3,50,72,.66)',borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:22,padding:14,...SHADOW},createIcon:{width:46,height:46,borderRadius:16,backgroundColor:COLORS.primary,alignItems:'center',justifyContent:'center',position:'absolute',left:14,top:15},createTitle:{fontSize:15,fontWeight:'900',color:COLORS.text,marginLeft:58},createSub:{fontSize:11,color:COLORS.textMuted,marginTop:4,lineHeight:16,marginLeft:58,marginRight:42},arrowCircle:{position:'absolute',right:14,top:20,width:36,height:36,borderRadius:18,backgroundColor:'rgba(69,229,241,.16)',alignItems:'center',justifyContent:'center'},
  form:{backgroundColor:'rgba(3,50,72,.76)',borderRadius:28,padding:20,borderWidth:1,borderColor:'rgba(255,255,255,.20)',gap:15,...SHADOW},modeTabs:{flexDirection:'row',gap:9,flexWrap:'wrap'},modeTab:{flex:1,minWidth:220,minHeight:62,borderRadius:18,borderWidth:1,borderColor:'rgba(255,255,255,.20)',backgroundColor:'rgba(255,255,255,.08)',paddingHorizontal:14,flexDirection:'row',alignItems:'center',gap:10},modeTabOn:{backgroundColor:COLORS.primary,borderColor:COLORS.primary},modeTabImport:{backgroundColor:COLORS.dark,borderColor:COLORS.dark},modeTitle:{fontSize:12,fontWeight:'900',color:COLORS.text},modeTitleOn:{color:'#fff'},modeSub:{fontSize:9,color:COLORS.textMuted,marginTop:2},modeSubOn:{color:'rgba(255,255,255,.58)'},
  formTop:{flexDirection:'row',alignItems:'center',gap:12},formTitle:{fontSize:22,fontWeight:'900',color:COLORS.text},formSub:{fontSize:11,color:COLORS.textMuted,marginTop:3},completeBadge:{width:68,height:60,borderRadius:18,backgroundColor:'rgba(69,229,241,.14)',alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:'rgba(255,255,255,.20)'},completeValue:{fontWeight:'900',fontSize:18,color:COLORS.primaryDark},completeLabel:{fontSize:8,color:COLORS.textMuted},progressTrack:{height:5,borderRadius:99,backgroundColor:'rgba(255,255,255,.16)',overflow:'hidden'},progressFill:{height:'100%',borderRadius:99,backgroundColor:COLORS.primary},
  autoFillBtn:{minHeight:84,borderRadius:21,backgroundColor:COLORS.dark,padding:14,overflow:'hidden'},autoFillBtnBusy:{opacity:.94},autoFillGlow:{position:'absolute',width:180,height:180,borderRadius:90,backgroundColor:'rgba(15,166,184,.18)',right:-45,top:-60},autoFillIcon:{width:48,height:48,borderRadius:16,backgroundColor:COLORS.primary,alignItems:'center',justifyContent:'center',position:'absolute',left:14,top:18},autoFillTitle:{color:'#fff',fontSize:14,fontWeight:'900',marginLeft:61},autoFillSub:{color:'rgba(255,255,255,.58)',fontSize:10,marginTop:4,lineHeight:15,marginLeft:61,marginRight:66},autoFillBadge:{position:'absolute',right:14,top:29,flexDirection:'row',alignItems:'center',gap:4,backgroundColor:'rgba(255,255,255,.08)',paddingHorizontal:9,paddingVertical:6,borderRadius:999},autoFillBadgeText:{fontSize:8,color:'#F5D98D',fontWeight:'900'},autoResult:{flexDirection:'row',gap:9,backgroundColor:'rgba(55,222,200,.13)',borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:16,padding:12},autoResultBusy:{backgroundColor:'rgba(244,214,155,.15)',borderColor:'#F3DFC0'},autoResultText:{fontSize:11,color:'#F4D69B',fontWeight:'800'},sourceWrap:{flexDirection:'row',flexWrap:'wrap',gap:6,marginTop:7},sourceChip:{backgroundColor:'rgba(69,229,241,.14)',paddingHorizontal:8,paddingVertical:4,borderRadius:999},sourceChipText:{fontSize:8,color:COLORS.primaryDark,fontWeight:'800'},
  steps:{flexDirection:'row',gap:8},stepTab:{flex:1,minHeight:46,borderRadius:14,borderWidth:1,borderColor:COLORS.border,backgroundColor:'rgba(255,255,255,.08)'},stepTabOn:{backgroundColor:'rgba(69,229,241,.14)',borderColor:'rgba(255,255,255,.20)'},stepNo:{position:'absolute',left:10,width:24,height:24,borderRadius:12,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255,255,255,.12)'},stepNoOn:{backgroundColor:COLORS.primary},stepNoText:{fontSize:10,fontWeight:'900',color:COLORS.textMuted},stepNoTextOn:{color:'#fff'},stepTabText:{fontSize:10,color:COLORS.textMuted,fontWeight:'900',marginLeft:32},stepTabTextOn:{color:COLORS.primaryDark},stepContent:{gap:13,paddingTop:3},
  sectionHeader:{flexDirection:'row',alignItems:'center',gap:10},sectionIcon:{width:38,height:38,borderRadius:14,backgroundColor:'rgba(69,229,241,.14)',alignItems:'center',justifyContent:'center'},sectionTitle:{fontSize:15,fontWeight:'900',color:COLORS.text},sectionSub:{fontSize:10,color:COLORS.textMuted,marginTop:2},field:{gap:6},fieldLabel:{fontSize:11,fontWeight:'900',color:COLORS.text},input:{minHeight:48,borderRadius:16,borderWidth:1,borderColor:'rgba(255,255,255,.20)',paddingHorizontal:13,paddingVertical:10,color:COLORS.text,backgroundColor:'rgba(255,255,255,.08)'},inline:{flexDirection:'row',gap:10,flexWrap:'wrap'},routeInput:{minHeight:72,textAlignVertical:'top'},noteInput:{minHeight:96,textAlignVertical:'top'},previewBox:{minHeight:44,borderRadius:14,backgroundColor:'rgba(255,255,255,.09)',paddingHorizontal:12,flexDirection:'row',alignItems:'center',gap:8},previewText:{fontSize:11,color:COLORS.textMuted,fontWeight:'700'},
  selectedWrap:{flexDirection:'row',flexWrap:'wrap',gap:7},selectedChip:{flexDirection:'row',alignItems:'center',gap:5,paddingHorizontal:9,paddingVertical:6,borderRadius:999,backgroundColor:'rgba(69,229,241,.14)'},selectedChipText:{fontSize:11,color:COLORS.primaryDark,fontWeight:'800'},provinceGrid:{flexDirection:'row',flexWrap:'wrap',gap:8},provinceOption:{minWidth:130,borderWidth:1,borderColor:COLORS.border,borderRadius:14,paddingHorizontal:11,paddingVertical:9,backgroundColor:'rgba(255,255,255,.08)'},provinceOptionOn:{borderColor:'rgba(255,255,255,.20)',backgroundColor:'rgba(69,229,241,.14)'},provinceOptionText:{fontSize:12,fontWeight:'800',color:COLORS.text},provinceOptionTextOn:{color:COLORS.primaryDark},provinceRegion:{fontSize:9,color:COLORS.textMuted,marginTop:2},choiceWrap:{flexDirection:'row',flexWrap:'wrap',gap:7},choice:{paddingHorizontal:12,paddingVertical:8,borderRadius:999,borderWidth:1,borderColor:COLORS.border,backgroundColor:'rgba(3,50,72,.66)',flexDirection:'row',alignItems:'center',gap:5},choiceOn:{backgroundColor:COLORS.dark,borderColor:COLORS.dark},choiceText:{fontSize:11,color:COLORS.textMuted,fontWeight:'800'},choiceTextOn:{color:'#fff'},wishBox:{flexDirection:'row',gap:9,backgroundColor:'rgba(255,134,163,.12)',borderRadius:16,padding:12},wishTitle:{fontSize:12,fontWeight:'900',color:COLORS.text},wishText:{fontSize:10,color:COLORS.textMuted,marginTop:3},
  budgetGrid:{flexDirection:'row',flexWrap:'wrap',gap:9},budgetBox:{minWidth:155,flex:1,borderWidth:1,borderColor:COLORS.border,borderRadius:16,padding:11,backgroundColor:'rgba(255,255,255,.08)'},budgetLabelRow:{flexDirection:'row',alignItems:'center',gap:6},budgetLabel:{fontSize:11,fontWeight:'800',color:COLORS.text},budgetInput:{fontSize:20,fontWeight:'900',color:COLORS.text,paddingVertical:7},baht:{fontSize:9,color:COLORS.textMuted},totalBox:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:12,backgroundColor:'rgba(244,214,155,.14)',borderRadius:16,padding:14},totalLabel:{fontSize:13,fontWeight:'900',color:COLORS.text},totalHint:{fontSize:10,color:COLORS.textMuted,marginTop:2},totalMoney:{fontSize:23,fontWeight:'900',color:'#F4D69B'},totalUnit:{fontSize:11},formActions:{flexDirection:'row',justifyContent:'space-between',gap:10},backBtn:{minHeight:46,paddingHorizontal:16,borderRadius:14,borderWidth:1,borderColor:COLORS.border,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},backText:{fontSize:12,fontWeight:'900',color:COLORS.text},nextBtn:{minHeight:46,paddingHorizontal:18,borderRadius:14,backgroundColor:COLORS.primary,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},nextText:{fontSize:12,fontWeight:'900',color:'#fff'},saveBtn:{minHeight:46,paddingHorizontal:18,borderRadius:14,backgroundColor:COLORS.dark,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},saveText:{fontSize:12,fontWeight:'900',color:'#fff'},
  importWrap:{gap:14},importHero:{backgroundColor:'rgba(69,229,241,.14)',borderRadius:20,padding:14,flexDirection:'row',alignItems:'center',gap:11,borderWidth:1,borderColor:'rgba(255,255,255,.20)'},importIcon:{width:48,height:48,borderRadius:16,backgroundColor:COLORS.dark,alignItems:'center',justifyContent:'center'},importTitle:{fontSize:15,fontWeight:'900',color:COLORS.text},importSub:{fontSize:10,color:COLORS.textMuted,lineHeight:15,marginTop:3},importInput:{minHeight:250,textAlignVertical:'top',fontSize:12,lineHeight:18},importActions:{flexDirection:'row',gap:9,flexWrap:'wrap'},parseBtn:{minHeight:48,paddingHorizontal:18,borderRadius:15,backgroundColor:COLORS.primary,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},importSaveBtn:{minHeight:48,paddingHorizontal:18,borderRadius:15,backgroundColor:COLORS.dark,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7},parseBtnText:{color:'#fff',fontSize:12,fontWeight:'900'},importStatus:{flexDirection:'row',alignItems:'center',gap:8,backgroundColor:'rgba(55,222,200,.13)',padding:11,borderRadius:14},importStatusText:{fontSize:11,fontWeight:'800',color:'#F4D69B'},parsePreview:{borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:20,padding:14,gap:12,backgroundColor:'rgba(255,255,255,.08)'},parsePreviewTop:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:12},parseEyebrow:{fontSize:8,color:COLORS.primaryDark,fontWeight:'900',letterSpacing:1},parseTitle:{fontSize:17,color:COLORS.text,fontWeight:'900',marginTop:3},parsedBadge:{width:58,height:58,borderRadius:18,backgroundColor:COLORS.dark,alignItems:'center',justifyContent:'center'},parsedBadgeN:{fontSize:19,fontWeight:'900',color:'#fff'},parsedBadgeL:{fontSize:8,color:'rgba(255,255,255,.58)'},parsedStats:{flexDirection:'row',gap:8,flexWrap:'wrap'},miniStat:{minWidth:135,flex:1,backgroundColor:'rgba(255,255,255,.09)',borderRadius:14,padding:10},miniStatValue:{fontSize:12,fontWeight:'900',color:COLORS.text,marginTop:5},miniStatLabel:{fontSize:9,color:COLORS.textMuted,marginTop:2},previewDays:{gap:7},previewDay:{flexDirection:'row',alignItems:'center',gap:9,padding:10,borderRadius:14,backgroundColor:'rgba(255,255,255,.08)'},previewDayNo:{width:30,height:30,borderRadius:15,backgroundColor:COLORS.primary,alignItems:'center',justifyContent:'center'},previewDayNoText:{color:'#fff',fontWeight:'900'},previewDayTitle:{fontSize:11,fontWeight:'900',color:COLORS.text},previewDayMeta:{fontSize:9,color:COLORS.textMuted,marginTop:3},parseHint:{fontSize:9,color:COLORS.textMuted,fontStyle:'italic'},
  empty:{backgroundColor:'rgba(3,50,72,.66)',borderRadius:24,padding:32,alignItems:'center',borderWidth:1,borderColor:COLORS.border},emptyIcon:{width:64,height:64,borderRadius:22,backgroundColor:'rgba(69,229,241,.14)',alignItems:'center',justifyContent:'center'},emptyTitle:{fontSize:18,fontWeight:'900',color:COLORS.text,marginTop:10},emptyText:{color:COLORS.textMuted,textAlign:'center',marginTop:5,maxWidth:460},
  card:{backgroundColor:'rgba(3,50,72,.66)',borderRadius:24,padding:17,borderWidth:1,borderColor:'rgba(255,255,255,.20)',...SHADOW,overflow:'hidden'},cardAccent:{position:'absolute',left:0,top:0,bottom:0,width:4,backgroundColor:COLORS.primary},cardTop:{flexDirection:'row',justifyContent:'space-between',gap:12},cardTitleRow:{flexDirection:'row',alignItems:'center',gap:7,flexWrap:'wrap'},cardTitle:{fontSize:19,fontWeight:'900',color:COLORS.text},autoBadge:{backgroundColor:'rgba(69,229,241,.14)',paddingHorizontal:7,paddingVertical:4,borderRadius:999},autoBadgeText:{fontSize:8,fontWeight:'900',color:COLORS.primaryDark},detailBadge:{backgroundColor:COLORS.dark,paddingHorizontal:8,paddingVertical:4,borderRadius:999},detailBadgeText:{fontSize:8,fontWeight:'900',color:'#fff'},cardSub:{color:COLORS.textMuted,fontSize:11,marginTop:4},cardActions:{flexDirection:'row',gap:8},iconBtn:{width:38,height:38,borderRadius:13,backgroundColor:'rgba(255,255,255,.09)',alignItems:'center',justifyContent:'center'},iconBtnDanger:{backgroundColor:'rgba(255,134,163,.14)'},readinessRow:{flexDirection:'row',justifyContent:'space-between',marginTop:12},readinessLabel:{fontSize:9,color:COLORS.textMuted,fontWeight:'800'},readinessValue:{fontSize:9,color:COLORS.primaryDark,fontWeight:'900'},readinessTrack:{height:4,backgroundColor:'rgba(255,255,255,.16)',borderRadius:99,overflow:'hidden',marginTop:5},readinessFill:{height:'100%',backgroundColor:COLORS.primary},tripMetaRow:{flexDirection:'row',flexWrap:'wrap',gap:7,marginTop:10},metaPill:{flexDirection:'row',alignItems:'center',gap:5,paddingHorizontal:8,paddingVertical:6,borderRadius:999,backgroundColor:'rgba(255,255,255,.08)'},tripMeta:{fontSize:9,color:COLORS.textMuted,fontWeight:'700'},chips:{flexDirection:'row',flexWrap:'wrap',gap:6,marginTop:10},chip:{flexDirection:'row',alignItems:'center',gap:4,paddingHorizontal:8,paddingVertical:5,borderRadius:999,backgroundColor:'rgba(69,229,241,.14)'},chipText:{fontSize:10,color:COLORS.primaryDark,fontWeight:'800'},sourceLine:{flexDirection:'row',alignItems:'center',gap:5,marginTop:9},sourceLineText:{fontSize:9,color:COLORS.primaryDark},routeStrip:{alignItems:'center',gap:7,paddingTop:11,paddingBottom:3},routeStop:{flexDirection:'row',alignItems:'center',gap:5,backgroundColor:'rgba(255,255,255,.09)',borderRadius:999,paddingHorizontal:9,paddingVertical:6},routeStopNo:{fontSize:8,color:'#fff',fontWeight:'900',backgroundColor:COLORS.primary,width:17,height:17,borderRadius:9,textAlign:'center',lineHeight:17},routeStopText:{fontSize:9,fontWeight:'800',color:COLORS.text},editBox:{gap:8,marginTop:12,padding:12,borderRadius:16,backgroundColor:'rgba(255,255,255,.08)'},editTitle:{fontSize:12,fontWeight:'900',color:COLORS.text},miniSave:{height:42,borderRadius:12,backgroundColor:COLORS.primary,alignItems:'center',justifyContent:'center',flexDirection:'row',gap:6},miniSaveText:{color:'#fff',fontWeight:'900',fontSize:11},expandBtn:{height:44,borderRadius:13,backgroundColor:'rgba(255,255,255,.09)',alignItems:'center',justifyContent:'center',marginTop:12,flexDirection:'row',gap:7},expandBtnOn:{backgroundColor:COLORS.dark},expandText:{fontSize:11,fontWeight:'900',color:COLORS.primaryDark},expandTextOn:{color:'#fff'},
  detailStack:{gap:12,marginTop:12},infoPanel:{flexDirection:'row',gap:9,backgroundColor:'rgba(255,255,255,.09)',borderRadius:16,padding:12},infoTitle:{fontSize:10,fontWeight:'900',color:COLORS.primaryDark},infoText:{fontSize:10,color:COLORS.textMuted,lineHeight:16,marginTop:3},timeline:{gap:0},dayWrap:{flexDirection:'row',gap:10},dayRail:{width:34,alignItems:'center'},dayRailLine:{position:'absolute',top:32,bottom:-10,width:2,backgroundColor:'rgba(130,244,251,.22)'},dayBubble:{width:32,height:32,borderRadius:16,backgroundColor:COLORS.dark,alignItems:'center',justifyContent:'center',zIndex:2},dayBubbleText:{color:'#fff',fontWeight:'900',fontSize:11},dayCard:{flex:1,borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:18,padding:13,marginBottom:12,backgroundColor:'rgba(255,255,255,.08)'},dayHeader:{flexDirection:'row',justifyContent:'space-between',gap:10,alignItems:'flex-start'},dayEyebrow:{fontSize:8,color:COLORS.primary,fontWeight:'900',letterSpacing:.8},dayTitle:{fontSize:14,fontWeight:'900',color:COLORS.text,marginTop:2},dayDate:{fontSize:9,color:COLORS.textMuted,marginTop:2},dayBudgetBadge:{backgroundColor:'rgba(244,214,155,.14)',borderRadius:999,paddingHorizontal:9,paddingVertical:6},dayBudgetBadgeText:{fontSize:8,fontWeight:'900',color:'#F4D69B'},schedule:{marginTop:12,gap:0},slot:{flexDirection:'row',gap:10},timeCol:{width:82,alignItems:'flex-end',paddingRight:12,position:'relative'},timeText:{fontSize:9,fontWeight:'900',color:COLORS.primaryDark},timeDot:{position:'absolute',right:1,top:4,width:8,height:8,borderRadius:4,backgroundColor:COLORS.primary},timeLine:{position:'absolute',right:4,top:12,bottom:-8,width:1,backgroundColor:'rgba(130,244,251,.22)'},slotBody:{flex:1,paddingBottom:14},slotTitle:{fontSize:12,fontWeight:'900',color:COLORS.text},slotDetail:{fontSize:10,color:COLORS.textMuted,lineHeight:15,marginTop:3},activityList:{gap:4,marginTop:7},activityRow:{flexDirection:'row',gap:6,alignItems:'flex-start'},activityText:{fontSize:10,color:COLORS.textMuted,flex:1,lineHeight:15},slotNote:{backgroundColor:'rgba(244,214,155,.14)',borderRadius:10,padding:8,marginTop:7},slotNoteText:{fontSize:9,color:'#F4D69B',lineHeight:14},dayFooterRow:{flexDirection:'row',alignItems:'center',gap:6,marginTop:9,paddingTop:9,borderTopWidth:1,borderTopColor:'rgba(255,255,255,.16)'},dayFooterText:{fontSize:10,color:COLORS.primaryDark,fontWeight:'800'},dayBudgetBox:{marginTop:9,backgroundColor:'rgba(255,255,255,.08)',borderRadius:12,padding:9},dayBudgetTitle:{fontSize:10,fontWeight:'900',color:COLORS.text,marginBottom:5},dayBudgetRow:{flexDirection:'row',justifyContent:'space-between',gap:10,paddingVertical:3},dayBudgetLabel:{fontSize:9,color:COLORS.textMuted},dayBudgetValue:{fontSize:9,fontWeight:'900',color:COLORS.text},dayNote:{flexDirection:'row',gap:6,backgroundColor:'rgba(255,255,255,.09)',padding:8,borderRadius:10,marginTop:8},dayNoteText:{fontSize:9,color:COLORS.primaryDark,lineHeight:14,flex:1},fallbackPlaces:{gap:7,marginTop:10},placeRow:{flexDirection:'row',alignItems:'center',gap:7,padding:8,borderRadius:10,backgroundColor:'rgba(255,255,255,.08)'},placeName:{fontSize:10,fontWeight:'900',color:COLORS.text},placeMeta:{fontSize:8,color:COLORS.textMuted,marginTop:2},placeMuted:{fontSize:10,color:COLORS.textMuted,fontStyle:'italic',marginTop:10},
  summaryPanel:{borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:18,padding:13,backgroundColor:'rgba(255,255,255,.08)'},miniTitleRow:{flexDirection:'row',alignItems:'center',gap:8,marginBottom:10},miniTitleIcon:{width:31,height:31,borderRadius:11,backgroundColor:'rgba(69,229,241,.14)',alignItems:'center',justifyContent:'center'},miniTitle:{fontSize:13,fontWeight:'900',color:COLORS.text},summaryList:{gap:7},summaryItem:{flexDirection:'row',alignItems:'center',gap:8},summaryNo:{width:22,height:22,borderRadius:11,backgroundColor:COLORS.dark,color:'#fff',fontSize:9,fontWeight:'900',textAlign:'center',lineHeight:22},summaryItemText:{fontSize:10,color:COLORS.text,flex:1},summaryChips:{flexDirection:'row',flexWrap:'wrap',gap:7},summaryChip:{flexDirection:'row',alignItems:'center',gap:5,backgroundColor:'rgba(255,255,255,.09)',borderRadius:999,paddingHorizontal:9,paddingVertical:6},summaryChipText:{fontSize:9,color:COLORS.primaryDark,fontWeight:'800'},accommodationGrid:{flexDirection:'row',flexWrap:'wrap',gap:8},nightCard:{minWidth:150,flex:1,backgroundColor:'rgba(255,255,255,.08)',borderRadius:12,padding:9},nightNo:{fontSize:8,color:COLORS.primaryDark,fontWeight:'900'},nightLocation:{fontSize:10,color:COLORS.text,fontWeight:'800',marginTop:3},heroBudget:{backgroundColor:'rgba(244,214,155,.14)',borderRadius:14,padding:11,marginBottom:8},heroBudgetLabel:{fontSize:9,color:'#F4D69B',fontWeight:'800'},heroBudgetValue:{fontSize:18,color:'#F4D69B',fontWeight:'900',marginTop:2},budgetSummaryLines:{gap:3},summaryLine:{fontSize:9,color:COLORS.textMuted,lineHeight:14},warningPanel:{backgroundColor:'rgba(244,214,155,.14)',borderWidth:1,borderColor:'rgba(255,255,255,.20)',borderRadius:18,padding:13},warningHead:{flexDirection:'row',alignItems:'center',gap:7,marginBottom:7},warningTitle:{fontSize:12,fontWeight:'900',color:'#F4D69B'},warningText:{fontSize:9,color:'#F4D69B',lineHeight:15},
});
