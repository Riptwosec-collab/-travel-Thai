...
const s=StyleSheet.create({
 wrap:{position:'absolute',left:11,right:11,alignItems:'center'},bar:{width:'100%',maxWidth:690,height:68,borderRadius:27,flexDirection:'row',alignItems:'center',paddingHorizontal:4,overflow:'visible',backgroundColor:'rgba(5,103,125,.54)'},
 nav:{flex:1,height:61},pressFill:{width:'100%',height:'100%',alignItems:'center',justifyContent:'center',flexDirection:'row'},navContent:{alignItems:'center',justifyContent:'center',gap:1},navIcon:{height:30,minWidth:36,borderRadius:15,alignItems:'center',justifyContent:'center'},navIconActive:{backgroundColor:'rgba(195,250,252,.18)',borderWidth:1,borderColor:'rgba(221,254,255,.30)'},label:{fontSize:8,fontWeight:'800',color:'rgba(255,255,255,.78)',marginTop:1},labelActive:{color:GLASS.white},
 addSlot:{width:66,height:68,alignItems:'center',justifyContent:'center'},add:{width:54,height:54,borderRadius:27,backgroundColor:'rgba(22,200,213,.96)',borderWidth:1,borderColor:'rgba(255,255,255,.72)',alignItems:'center',justifyContent:'center',shadowColor:GLASS.aqua,shadowOpacity:.40,shadowRadius:20,elevation:12,overflow:'hidden'},addGlow:{position:'absolute',width:48,height:22,borderRadius:18,top:3,backgroundColor:'rgba(255,255,255,.24)'},
