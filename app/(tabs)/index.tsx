...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:COLORS.background},content:{paddingBottom:120},page:{padding:SPACING.lg,gap:20,maxWidth:1440,width:'100%',alignSelf:'center'},pressFill:{width:'100%',height:'100%',justifyContent:'center',flexDirection:'row',alignItems:'center'},
 ...
 rowTitle:{flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between',gap:12,marginTop:2},linkBtn:{minHeight:36,paddingHorizontal:10},link:{fontWeight:'800',color:COLORS.primary,fontSize:12,marginRight:6},recommendedList:{gap:14,paddingBottom:8,paddingRight:SPACING.lg},
 provinceGrid:{gap:10},provinceGridTablet:{flexDirection:'row',flexWrap:'wrap'},province:{minHeight:72,backgroundColor:COLORS.surface,borderRadius:RADIUS.md,padding:12,borderWidth:1,borderColor:COLORS.border,minWidth:300,flex:1},provinceNo:{width:38,height:38,borderRadius:12,backgroundColor:'#E7F6F6',alignItems:'center',justifyContent:'center'},provinceNoText:{fontWeight:'900',fontSize:10,color:COLORS.primary},provinceCopy:{flex:1,marginLeft:11},provinceName:{fontWeight:'900',color:COLORS.text,fontSize:15},provinceRegion:{color:COLORS.textMuted,fontSize:10,marginTop:3},
