  ...
  <SafeAreaView style={s.safe}>
   <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
    <View style={[s.page,wide&&s.pageWide]}>
     <GlassPageEnter>
      <View style={[s.topBar,phone&&s.topBarPhone]}>
       {tablet&&<View style={s.brandRow}>
     ...
     <GlassPageEnter delay={70}>
      <View style={[s.greetingRow,phone&&s.greetingRowPhone]}>
     ...
     <View style={[s.heroGrid,wide&&s.heroGridWide]}>
      <GlassPageEnter delay={170} style={{flex:1}}>
       <GlassCard strong style={[s.progressHero,phone&&s.progressHeroPhone]}>
        ...
        <View style={s.heroMain}>
         ...
         {tablet&&<View style={s.progressRing}><Text style={s.progressRingValue}>{progress}%</Text><Text style={s.progressRingLabel}>สำรวจแล้ว</Text></View>}
        </View>
       </GlassCard>
      </GlassPageEnter>

      {tablet&&<GlassPageEnter delay={220} style={[s.statsWrap,wide&&s.statsWrapWide]}>
     ...
     <GlassPageEnter delay={260}>
      {tablet&&<GlassSection title="ทางลัด" subtitle="Quick access"/>}
      <View style={[s.quickGrid,phone&&s.quickGridPhone,tablet&&s.quickGridTablet]}>
     ...
     <GlassPageEnter delay={310}>
      ...
      <FlatList data={recommended} keyExtractor={x=>x.id} horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.recommended} renderItem={({item})=><View style={{width:tablet?288:124}}><PlaceCard place={item} compact={!phone} mini={phone}/></View>}/>
     </GlassPageEnter>
...
const s=StyleSheet.create({
 safe:{flex:1},content:{paddingBottom:126},page:{width:'100%',maxWidth:1460,alignSelf:'center',paddingHorizontal:16,paddingTop:5,gap:14},pageWide:{paddingHorizontal:34},
 ...
 topBarPhone:{justifyContent:'flex-end',height:40},greetingRow:{flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between',gap:16},greetingRowPhone:{marginTop:-40,paddingRight:48},greetingSmall:{fontSize:13,fontWeight:'700',color:'rgba(255,255,255,.90)'},greeting:{fontSize:27,fontWeight:'900',color:GLASS.white,letterSpacing:-.55,marginTop:1},greetingSub:{fontSize:12,color:'rgba(255,255,255,.84)',marginTop:3},
 heroGrid:{gap:10},heroGridWide:{flexDirection:'row',alignItems:'stretch'},progressHero:{minHeight:205,padding:20},progressHeroPhone:{minHeight:158,padding:14},heroGlowA:{position:'absolute',width:250,height:250,borderRadius:125,right:-80,top:-100,backgroundColor:'rgba(210,252,255,.17)'},heroGlowB:{position:'absolute',width:180,height:180,borderRadius:90,left:-70,bottom:-100,backgroundColor:'rgba(255,225,165,.10)'},heroMain:{flex:1,flexDirection:'row',alignItems:'center',gap:20},heroCopy:{flex:1,minWidth:0},heroEyebrow:{fontSize:9,fontWeight:'900',letterSpacing:.8,color:GLASS.white},heroNumberRow:{flexDirection:'row',alignItems:'baseline',marginTop:6},heroNumber:{fontSize:34,fontWeight:'900',color:GLASS.white,letterSpacing:-1},heroSlash:{fontSize:24,fontWeight:'700',color:'rgba(255,255,255,.90)'},heroUnit:{fontSize:11,fontWeight:'800',color:'rgba(255,255,255,.82)',marginLeft:5},heroSub:{fontSize:10,color:'rgba(255,255,255,.82)',marginTop:3,lineHeight:15},progressMeta:{flexDirection:'row',justifyContent:'space-between',marginTop:11,marginBottom:6},progressMetaText:{fontSize:8,fontWeight:'900',letterSpacing:.7,color:'rgba(255,255,255,.82)'},mapCta:{alignSelf:'flex-end',minHeight:32,borderRadius:GLASS_RADIUS.pill,paddingHorizontal:11,marginTop:8,backgroundColor:'rgba(255,255,255,.18)',borderWidth:1,borderColor:'rgba(255,255,255,.32)'},mapCtaText:{fontSize:9,fontWeight:'900',color:GLASS.white,marginRight:5},progressRing:{width:90,height:90,borderRadius:45,borderWidth:6,borderColor:GLASS.gold,backgroundColor:'rgba(255,255,255,.10)',alignItems:'center',justifyContent:'center'},progressRingValue:{fontSize:20,fontWeight:'900',color:GLASS.white},progressRingLabel:{fontSize:8,fontWeight:'800',color:'rgba(255,255,255,.72)',marginTop:2},
 ...
 quickGrid:{flexDirection:'row',flexWrap:'wrap',gap:9,marginTop:9},quickGridPhone:{flexWrap:'nowrap',marginTop:0},quickGridTablet:{flexWrap:'nowrap'},quick:{flex:1,minWidth:0,minHeight:88,borderRadius:GLASS_RADIUS.md,flexDirection:'column',padding:10,alignItems:'center'},quickIcon:{width:38,height:38,borderRadius:14,backgroundColor:'rgba(255,255,255,.17)',alignItems:'center',justifyContent:'center'},quickLabel:{fontSize:11,fontWeight:'900',color:GLASS.white,marginTop:6},quickEn:{fontSize:7,fontWeight:'700',color:'rgba(255,255,255,.72)',marginTop:1},
 textLink:{minHeight:34,paddingHorizontal:7},textLinkText:{fontSize:10,fontWeight:'900',color:GLASS.white,marginRight:3},recommended:{gap:9,paddingTop:9,paddingBottom:4,paddingRight:18},
